...
# Generated on: Thu Mar 12 12:47:03 CET 2026 (Thu Mar 12 11:47:03 UTC 2026)
...
set_log_file fv/et4351/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/et4351 -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/eda/cadence/2021-22/RHELx86/GENUS_21.10.000/tools.lnx86"
set CDN_SYNTH_ROOT      "/eda/cadence/2021-22/RHELx86/GENUS_21.10.000/tools.lnx86"
set env(CW_DIR) "/eda/cadence/2021-22/RHELx86/GENUS_21.10.000/tools.lnx86/lib/chipware"
set CW_DIR      "/eda/cadence/2021-22/RHELx86/GENUS_21.10.000/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_notranslate_modules -library -both SRAM1RW256x8

add_search_path /data/Cadence/gpdk045_v60/gsclib045_svt_v4.7/gsclib045/ /data/Cadence/gpdk045_v60/Synopsys_sram/ -library -both
read_library -liberty -both /data/Cadence/gpdk045_v60/gsclib045_svt_v4.7/gsclib045/timing/slow_vdd1v0_basicCells.lib /data/Cadence/gpdk045_v60/Synopsys_sram/saed32sram_ss0p95vn40c.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../src/design/et4351.v
delete_search_path -all -design -golden
add_search_path ../src/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../src/design/accelerator.v
delete_search_path -all -design -golden
add_search_path ../src/ -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../src/design/accelerator_fft.v
delete_search_path -all -design -golden
add_search_path ../src/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../src/design/accelerator_mem.v
delete_search_path -all -design -golden
add_search_path ../src/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../src/design/picosoc.v
delete_search_path -all -design -golden
add_search_path ../src/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../src/design/spimemio.v
delete_search_path -all -design -golden
add_search_path ../src/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../src/design/simpleuart.v
delete_search_path -all -design -golden
add_search_path ../src/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../src/design/picorv32.v
elaborate_design -golden -root {et4351} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/et4351/fv_map.v.gz
elaborate_design -revised -root {et4351}
...
#add_name_alias fv/et4351/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/et4351/rtl_to_fv_map.log
}
